...
namespace Alish\FileManager\Middleware;

use Alish\FileManager\Services\ACLService\ACL;
use Alish\FileManager\Services\ConfigService\ConfigRepository;
use Alish\FileManager\Traits\PathTrait;
...
class FileManagerACL
{
     ...
     */
    const CHECKERS = [
        'alishfm.tree'             => 'checkContent',
        'alishfm.content'          => 'checkContent',
        'alishfm.preview'          => 'checkContent',
        'alishfm.thumbnails'       => 'checkContent',
        'alishfm.url'              => 'checkContent',
        'alishfm.stream-file'      => 'checkContent',
        'alishfm.download'         => 'checkDownload',
        'alishfm.create-file'      => 'checkCreate',
        'alishfm.create-directory' => 'checkCreate',
        'alishfm.update-file'      => 'checkUpdate',
        'alishfm.upload'           => 'checkUpload',
        'alishfm.delete'           => 'checkDelete',
        'alishfm.paste'            => 'checkPaste',
        'alishfm.rename'           => 'checkRename',
        'alishfm.zip'              => 'checkZip',
        'alishfm.unzip'            => 'checkUnzip',
    ];
